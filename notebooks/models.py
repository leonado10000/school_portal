...
class SubmissionRecord(models.Model):
    ...
    associated_subject = models.ForeignKey(Subject, on_delete=models.CASCADE, default=1)
    associated_batch = models.ForeignKey(Batch, on_delete=models.CASCADE, default=1)
